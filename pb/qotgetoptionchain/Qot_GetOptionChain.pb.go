...
type DataFilter struct {
	...
	ImpliedVolatilityMin *float64 `protobuf:"fixed64,1,opt,name=impliedVolatilityMin" json:"impliedVolatilityMin,omitempty"` //隐含波动率过滤起点
	ImpliedVolatilityMax *float64 `protobuf:"fixed64,2,opt,name=impliedVolatilityMax" json:"impliedVolatilityMax,omitempty"` //隐含波动率过滤终点
	DeltaMin             *float64 `protobuf:"fixed64,3,opt,name=deltaMin" json:"deltaMin,omitempty"`                         //希腊值 Delta过滤起点
	DeltaMax             *float64 `protobuf:"fixed64,4,opt,name=deltaMax" json:"deltaMax,omitempty"`                         //希腊值 Delta过滤终点
	GammaMin             *float64 `protobuf:"fixed64,5,opt,name=gammaMin" json:"gammaMin,omitempty"`                         //希腊值 Gamma过滤起点
	GammaMax             *float64 `protobuf:"fixed64,6,opt,name=gammaMax" json:"gammaMax,omitempty"`                         //希腊值 Gamma过滤终点
	VegaMin              *float64 `protobuf:"fixed64,7,opt,name=vegaMin" json:"vegaMin,omitempty"`                           //希腊值 Vega过滤起点
	VegaMax              *float64 `protobuf:"fixed64,8,opt,name=vegaMax" json:"vegaMax,omitempty"`                           //希腊值 Vega过滤终点
	ThetaMin             *float64 `protobuf:"fixed64,9,opt,name=thetaMin" json:"thetaMin,omitempty"`                         //希腊值 Theta过滤起点
	ThetaMax             *float64 `protobuf:"fixed64,10,opt,name=thetaMax" json:"thetaMax,omitempty"`                        //希腊值 Theta过滤终点
	RhoMin               *float64 `protobuf:"fixed64,11,opt,name=rhoMin" json:"rhoMin,omitempty"`                            //希腊值 Rho过滤起点
	RhoMax               *float64 `protobuf:"fixed64,12,opt,name=rhoMax" json:"rhoMax,omitempty"`                            //希腊值 Rho过滤终点
	NetOpenInterestMin   *float64 `protobuf:"fixed64,13,opt,name=netOpenInterestMin" json:"netOpenInterestMin,omitempty"`    //净未平仓合约数过滤起点
	NetOpenInterestMax   *float64 `protobuf:"fixed64,14,opt,name=netOpenInterestMax" json:"netOpenInterestMax,omitempty"`    //净未平仓合约数过滤终点
	OpenInterestMin      *float64 `protobuf:"fixed64,15,opt,name=openInterestMin" json:"openInterestMin,omitempty"`          //未平仓合约数过滤起点
	OpenInterestMax      *float64 `protobuf:"fixed64,16,opt,name=openInterestMax" json:"openInterestMax,omitempty"`          //未平仓合约数过滤终点
	VolMin               *float64 `protobuf:"fixed64,17,opt,name=volMin" json:"volMin,omitempty"`                            //成交量过滤起点
	VolMax               *float64 `protobuf:"fixed64,18,opt,name=volMax" json:"volMax,omitempty"`                            //成交量过滤终点
}
...
type OptionItem struct {
	...
	Call *qotcommon.SecurityStaticInfo `protobuf:"bytes,1,opt,name=call" json:"call,omitempty"` //看涨,不一定有该字段,由请求条件决定
	Put  *qotcommon.SecurityStaticInfo `protobuf:"bytes,2,opt,name=put" json:"put,omitempty"`   //看跌,不一定有该字段,由请求条件决定
}
...
var file_Qot_GetOptionChain_proto_rawDesc = []byte{
	...
	0x02, 0x42, 0x44, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x75, 0x74, 0x75, 0x2e, 0x6f, 0x70,
	0x65, 0x6e, 0x61, 0x70, 0x69, 0x2e, 0x70, 0x62, 0x5a, 0x2d, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x6e, 0x7a, 0x61, 0x69, 0x2f, 0x66, 0x74, 0x61, 0x70, 0x69, 0x34,
	0x67, 0x6f, 0x2f, 0x70, 0x62, 0x2f, 0x71, 0x6f, 0x74, 0x67, 0x65, 0x74, 0x6f, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x63, 0x68, 0x61, 0x69, 0x6e,
}
